        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden md:block text-left text-xs">
              <div className="font-semibold text-slate-900 dark:text-slate-100">{user?.name || 'Sankar'}</div>
              <div className="text-[10px] text-brand-600 dark:text-brand-400 font-medium uppercase">{user?.planId || 'PRO'} Plan</div>
            </div>
          </button>
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-56 p-2 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl z-50 animate-in fade-in duration-150">
                <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-800 mb-1">
                  <div className="text-xs font-bold text-slate-900 dark:text-white">{user?.name || 'Sankar'}</div>
                  <div className="text-[11px] text-slate-500 truncate">{user?.email || 'sankar@docuflow.ai'}</div>
                </div>
